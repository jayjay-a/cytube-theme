...
//happy halloween
$(".navbar-brand").before("<img style='-webkit-user-select: none' height='40px' src='//i.imgur.com/SBlByCW.gif'>");
	...
	! function() {
        ...
        function o(e, t) {
            ...
            var o = "position: absolute; left: 0; top: 0; right: 0; bottom: 0; overflow: scroll; z-index: -1; visibility: hidden;",
                n = "position: absolute; left: 0; top: 0;";
            e.resizeSensor.style.cssText = o, e.resizeSensor.innerHTML = '<div class="resize-sensor-expand" style="' + o + '"><div style="' + n + '"></div></div><div class="resize-sensor-shrink" style="' + o + '"><div style="' + n + ' width: 200%; height: 200%"></div></div>', e.appendChild(e.resizeSensor), {
                fixed: 1,
                absolute: 1
            }[i(e, "position")] || (e.style.position = "relative");
            var r, l, d = e.resizeSensor.childNodes[0],
                c = d.childNodes[0],
                h = e.resizeSensor.childNodes[1],
                a = (h.childNodes[0], function() {
                    c.style.width = d.offsetWidth + 10 + "px", c.style.height = d.offsetHeight + 10 + "px", d.scrollLeft = d.scrollWidth, d.scrollTop = d.scrollHeight, h.scrollLeft = h.scrollWidth, h.scrollTop = h.scrollHeight, r = e.offsetWidth, l = e.offsetHeight
                });
           a();
            var f = function() {
                ...
                z = function() {
                    (e.offsetWidth != r || e.offsetHeight != l) && f(), a()
                };
            u(d, "scroll", z), u(h, "scroll", z)
        }
        ...
        if (r)
            for (var l = 0, d = e.length; d > l; l++) o(e[l], t);
        else o(e, t);
        this.detach = function() {
            if (r)
                for (var t = 0, s = e.length; s > t; t++) ResizeSensor.detach(e[t]);
            else ResizeSensor.detach(e)
        }
...
$('head').append("<link rel='stylesheet' href='//cdn.rawgit.com/jayjay-a/cytube-theme/master/base.css' />");
$('head').append("<link rel='stylesheet' href='//cdn.rawgit.com/jayjay-a/cytube-theme/master/polyzor.css' />");
...
$('<link id="chanfavicon" href="//i.imgur.com/7jBXqM3.png" type="image/x-icon" rel="shortcut icon" />')
.appendTo("head");});
...
//$.getScript("//rawgit.com/BillTube/theme/gh-pages/channels.js"); //other channels?
$.getScript("//cdn.rawgit.com/jayjay-a/cytube-theme/master/overlay.js");
$.getScript("//cdn.rawgit.com/jayjay-a/cytube-theme/master/XaekaiModules.js");
$.getScript("//cdn.rawgit.com/jayjay-a/cytube-theme/master/settings.js");
...
var bgColorArray = ['//images5.alphacoders.com/716/716203.png'],
